...
import com.app.app.util.CustomDictWordUtils;
...
public class ConfigRunner implements CommandLineRunner {
    ...
    @Value("C:/Users/lenovo/IdeaProjects/app/src/main/resources/dictionary/custom/movieDict.txt")
    private String movieDictPath;

    @Value("C:/Users/lenovo/IdeaProjects/app/src/main/resources/dictionary/custom/genreDict.txt")
    private String genreDictPath;

    @Value("C:/Users/lenovo/IdeaProjects/app/src/main/resources/dictionary/custom/scoreDict.txt")
    private String scoreDictPath;

    @Value("C:/Users/lenovo/IdeaProjects/app/src/main/resources/dictionary/custom/CustomDictionary.txt.bin")

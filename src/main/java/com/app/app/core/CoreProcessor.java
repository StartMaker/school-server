...
public class CoreProcessor {
    ...
    public NaiveBayesModel loadClassifierModel() throws Exception {
        ...
        String[] sentences;
        Map<Double, String> seqWithSamples = loadQuestionSamples("template");
        System.out.println(seqWithSamples);
        System.out.println(seqWithSamples == null);
